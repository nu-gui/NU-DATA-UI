/**
 * Custom easing functions extracted from Figma design
 * These can be used with Framer Motion and GSAP animations
 */
...
export const gsapEasings = {
  ...
  modalEnter: "back.out(1.7)",
  modalExit: "back.in(1.7)",
